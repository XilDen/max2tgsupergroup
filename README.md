...
Лицензия: проект распространяется на условиях MIT License, см. [LICENSE](LICENSE). Подробный отказ от гарантий, поддержки, SLA, доступности, безопасности и пригодности для конкретной цели вынесен в [NOTICE.md](NOTICE.md).
...
The software is provided without warranty, support, SLA, availability promises, security promises, or fitness-for-purpose promises. See [NOTICE.md](NOTICE.md) for the full project notice and disclaimer.
